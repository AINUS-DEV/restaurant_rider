...
import 'package:restaurant_rider/view/screens/order/order_details_screen.dart';
                            ...
                            Provider.of<OrderProvider>(context, listen: false).updateOrderStatus(
                              ...
                              if (value.isSuccess) {
                                order.updatePaymentStatus(
                                    token: Provider.of<AuthProvider>(context, listen: false).getUserToken(), orderId: orderModel.id, status: 'paid', index: index);
