...
import 'package:restaurant_rider/helper/email_checker.dart';
...
import 'package:restaurant_rider/view/base/custom_snackbar.dart';
import 'package:restaurant_rider/view/base/custom_text_field.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    String _password = Provider.of<AuthProvider>(context, listen: false).getUserEmail();

    _emailController.text = (_email == null || _email.isEmpty) ? 'demo@demo.com' : _email;
    _passwordController.text = (_password == null || _password.isEmpty) ? '123456' : _password;
  }
